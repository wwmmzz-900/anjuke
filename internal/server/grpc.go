...
func NewGRPCServer(c *conf.Server, user *service.UserService, house *service.HouseService, transaction *service.TransactionService, points *service.PointsService, customer *service.CustomerService, orderService *service.OrderService, logger log.Logger) *grpc.Server {
	...
	v7.RegisterOrderServer(srv, orderService)
	return srv
}
