...
type ChatSession struct {
	...
	Status       string    `gorm:"column:status;size:20;not null" json:"status"`             // 状态：active/closed
...
type ChatMessage struct {
	...
	Type         int       `gorm:"column:type;not null" json:"type"`                         // 消息类型：0-文本，1-图片，2-语音，3-位置，4-系统消息
