...
type HouseClient interface {
	CreateHouse(ctx context.Context, in *CreateHouseRequest, opts ...grpc.CallOption) (*v1.BaseResponse, error)
}
...
func (c *houseClient) CreateHouse(ctx context.Context, in *CreateHouseRequest, opts ...grpc.CallOption) (*v1.BaseResponse, error) {
...
type HouseServer interface {
	CreateHouse(context.Context, *CreateHouseRequest) (*v1.BaseResponse, error)
	mustEmbedUnimplementedHouseServer()
}

// UnimplementedHouseServer must be embedded to have
...
func (UnimplementedHouseServer) CreateHouse(context.Context, *CreateHouseRequest) (*v1.BaseResponse, error) {
...
func (UnimplementedHouseServer) testEmbeddedByValue()               {}
...
func RegisterHouseServer(s grpc.ServiceRegistrar, srv HouseServer) {
	// If the following call pancis, it indicates UnimplementedHouseServer was
