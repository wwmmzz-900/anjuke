...
type HouseHTTPClient interface {
	CreateHouse(ctx context.Context, req *CreateHouseRequest, opts ...http.CallOption) (rsp *v1.BaseResponse, err error)
}
...
func (c *HouseHTTPClientImpl) CreateHouse(ctx context.Context, in *CreateHouseRequest, opts ...http.CallOption) (*v1.BaseResponse, error) {
