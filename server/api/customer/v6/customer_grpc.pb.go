...
const (
	Customer_CreateCustomer_FullMethodName = "/api.customer.v6.Customer/CreateCustomer"
)
...
type CustomerClient interface {
	CreateCustomer(ctx context.Context, in *CreateCustomerRequest, opts ...grpc.CallOption) (*v1.BaseResponse, error)
}
...
func (c *customerClient) CreateCustomer(ctx context.Context, in *CreateCustomerRequest, opts ...grpc.CallOption) (*v1.BaseResponse, error) {
...
func (UnimplementedCustomerServer) CreateCustomer(context.Context, *CreateCustomerRequest) (*v1.BaseResponse, error) {
...
var Customer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.customer.v6.Customer",
	...
	Metadata: "customer/v6/customer.proto",
}
